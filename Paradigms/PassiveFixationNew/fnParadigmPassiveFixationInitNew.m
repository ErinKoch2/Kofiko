...
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'FixationSpotPix', [750, 500], iSmallBuffer);
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'StimulusPos',[750, 500], iSmallBuffer);
% overwritten by MYZ
